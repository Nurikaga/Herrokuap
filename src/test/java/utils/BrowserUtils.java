...
public class BrowserUtils {
    ...
    private static void getRemoteDriver(){
        String sauceKey = "4bd04672-e6f2-421c-838d-1a89ce9f20e8";
        String sauceUsername = "oauth-nicksbastion-41b4b";
        ...
        try{
            ...
            capabilities.setCapability("name", "Home Scenarios");
        ...
        for (int i = 0; i < 2; i++) {
            try {
                if (i % 2 == 0) {
                    ...
                    sleep(200);
                    CucumberLogUtils.logInfo("clicked on " + element.toString(), true);
                } else {
                    sleep(600);
